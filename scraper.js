const movies = [
  ...
  "jung-war-in-the-land-of-mujaheddin",
  "the-lady-from-the-town",
  ...
  "black-robe",
  "the-mysterious-geo.-explorations-of-jasper-morello",
  "flirting",
  "not-quite-hollywood!",
  "the-interview",
  "the-black-balloon",
  ...
  "the-bone-man",
  "comedian-harmonists",
  "71-fragments-of-a-chronicles-of-chance",
  "code-unknown",
  "copy-shop",
  "fast-film",
  "dog-days",
  ...
  "all-for-love",
  "the-world-is-big-and-s.-lurks-around-the-cor.",
  "time-of-violence",
  "khan-asparoukh",
  "ladies'-choice",
  ...
  "our-father",
  "a-screaming-man",
  "the-battle-of-chile:-part-1,2,3",
  "the-holy-mountain",
  "dialogues-of-exiles",
  ...
  "magdana\u2019s-donkey",
  "blue-mountains---unbelievable-story",
  "don't-grieve",
  "13-tzameti",
  "falling-leaves",
  "repentance",
  ...
  "voitheia-o-vengos-apparent-agent-000",
  "stella",
  ...
  "-jausmai",
  "kids-from-american-hotel",
  "zero",
  "before-flying-back-to-earth",
  "the-flight-over-lithuania-or-510-seconds-of-silence",
  "elze's-life",
  "forest-of-the-gods",
  "macedonian-folk-stories",
  "before-the-rain",
  ...
  "father-and-daughter",
  "twin-sisters",
  "dexter-the-dragon-and-bumble-the-bear",
  "the-assault",
  "left-luggage",
  "cloaca",
  "the-northerns",
  ...
  "the-decalogue",
  "stuffy's-errand-of-mercy",
  "three-colors:-red",
  "three-colors:-blue-",
  "4-disjunction-street",
  "knife-in-the-water",
  "ashes-and-diamonds",
  "the-cruise",
  "kanal",
  ...
  "doris'-days",
  "linda-sara",
  "heroes-from-another-country",
  "the-moromete",
  "michael-the-brave",
  "operation-monster",
  "full-sail",
  "the-miscellaneous-brigade",
  ...
  "andrei-roublev",
  "the-adventures-of-s.-holmes-and-dr.-watson",
  "ivan-the-terrible",
  "you-just-wait!",
  ...
  "cabaret-balkan",
  "w.r.:-mysteries-of-the-organism-w.r.",
  "huddersfield",
  "the-trap",
  "tito-and-me",
  "professional",
  ...
  "i-am-the-one-that-carries-the-flowers-to-her-grave",
  "oral-messages",
  "the-deceived",
  "the-extras",
  "the-syrian-bride",
  ...
  "best-directors-from-turkey---top-30",
  "ertem-e\u011filmez",
  "at\u0131f-y\u0131lmaz",
  "yavuz-turgul",
  "metin-erksan",
  ...
  "hulki-saner",
  "tun\u00e7-ba\u015faran",
  "best-actors-from-turkey---top-100",
  "kemal-sunal",
  "t\u00fcrkan-\u015foray",
  "sadri-al\u0131\u015f\u0131k",
  "m\u00fcnir-\u00f6zkul",
...
const translate = () => {
  movies.forEach(async (title) => await fetch(`http://www.omdbapi.com/?apikey=63d9b3b1&t=${title}`))
  .then(response => {
    console.log(response)
    return response.imdbID
  }).then(response => result.title = response);
}
